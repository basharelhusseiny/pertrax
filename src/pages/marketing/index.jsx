...
export default function MarketingPage({ t, lang }) {
  ...
  const [formData, setFormData] = useState({
    ...
    brandingColor: '', webFeatures: [], socialPlatforms: [], generalNotes: ''
  });
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden selection:bg-[#1A1AFA] selection:text-white relative" style={{background: 'linear-gradient(180deg, #03030f 0%, #04041e 100%)'}}>
      <CanvasBackground />
