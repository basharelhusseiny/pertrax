...
export default function PrivacyPolicy({ t, lang }) {
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-indigo-600/5 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/10 border border-blue-500/20 mb-6 group">
            <Shield className="w-8 h-8 text-blue-500 transition-transform duration-500 group-hover:scale-110" />
          </div>
        ...
        >
          ...
          >
            <p className="text-blue-400/40 text-sm italic">
              {isAr
                ? "إذا كانت لديك أي أسئلة، يرجى التواصل معنا عبر البريد الإلكتروني: info@petrax-sa.com"
                : "If you have any questions, please contact us at info@petrax-sa.com"}
            </p>
          </Motion.div>
        </Motion.div>
      </div>
